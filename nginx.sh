...
sudo s3fs rudi17 /var/www/sosial-media-master -o passwd_file=/home/ubuntu/.passwd-s3fs -o url=https://s3.ap-southeast-1.amazonaws.com -ouid=1001,gid=1001,allow_other
